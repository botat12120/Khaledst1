...
if (!text) return conn.reply(message.chat, '🍟 *ما الذي تريد البحث عنه في منصة tiktok?*', message, rcanal)
...
footer: proto.Message.InteractiveMessage.Footer.create({ text: 'By Pachira🍷' }),
...
handler.help = ['تيك_بحث <txt>']
handler.register = false
handler.tags = ['buscador']
handler.command = ['tiktoksearch', 'تيك']
